        ...
        success: function(response) {
            ...
            if (response && response.user_id) {
                ...
                if(response.user_id === boardUserId) {
                    ...
                    $('#deleteButton').html('<button class="deleteButton" onclick="window.location.href=\'/deleteReport/'+ boardNo +'\'">삭제하기</button>');
                    $('#editButton').html('<button class="editButton" onclick="window.location.href=\'/editReport/' + boardNo + '\'">수정하기</button>');
                } else {
