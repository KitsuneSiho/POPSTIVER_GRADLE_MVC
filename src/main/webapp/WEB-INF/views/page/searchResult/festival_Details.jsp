...
<div class="detailInfo">
    ...
    <div class="reviewWrite">
        <input type="text" class="visit_date" name="visit_date" placeholder="방문일을 입력해주세요.">
        <input type="text" class="comment_content" name="comment_content" placeholder="후기를 입력해주세요.">
