...
<div class="contactMenu">
    <a href="${root}/contact"><h2>공지사항</h2></a>
    <a href="${root}/money"><h2>비즈니스 문의</h2></a>
    <a href="${root}/report"><h2>제보하기</h2></a>
    <a href="${root}/together"><h2>동행구하기</h2></a>
    <a class="on" href="${root}/free"><h2>자유게시판</h2></a>
</div>
...
<div class="write">
    <button class="writeButton" onclick="window.location.href='${root}/freeWrite'">
