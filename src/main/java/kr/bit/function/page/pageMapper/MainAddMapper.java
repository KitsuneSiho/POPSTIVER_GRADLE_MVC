...
public interface MainAddMapper {
    @Select("SELECT popup_no,popup_title, popup_location, popup_start, popup_end, popup_attachment FROM popup")
    List<PopupEntity> getAllPopups();

    @Select("SELECT festival_no, festival_title, festival_location, festival_start, festival_end, festival_attachment FROM festival")
