...
public class CommunityDTO {
    ...
    public CommunityDTO(int board_no,String board_title, String board_content, String user_id, String user_name, String board_post_date, String board_attachment, int board_views) {
        super();
